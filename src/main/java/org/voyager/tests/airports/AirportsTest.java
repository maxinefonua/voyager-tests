...
public class AirportsTest {
    ...
    public void getIataCodesType() {
        RestAssured.given()
                .spec(requestSpec)
                .when()
                .queryParam(ParameterNames.TYPE_PARAM_NAME,"faketype")
                .get(Path.IATA)
                .then()
                .assertThat()
                .statusCode(400)
        ...
        RestAssured.given()
                .spec(requestSpec)
                .when()
                .queryParam(ParameterNames.TYPE_PARAM_NAME,"unverified")
                .get(Path.IATA)
                .then()
                .assertThat()
                .statusCode(200)
    ...
    public void getIataCodesAirline() {
        ...
        RestAssured.given()
                .spec(requestSpec)
                .when()
                .queryParam(ParameterNames.AIRLINE_PARAM_NAME,"japan")
                .get(Path.IATA)
                .then()
                .assertThat()
                .statusCode(200)
    ...
    public void getPagedAirportsCountry() {
        RestAssured.given()
                .spec(requestSpec)
                .when()
                .queryParam(ParameterNames.COUNTRY_CODE_PARAM_NAME,"12")
                .get(Path.AIRPORTS)
                .then()
                .assertThat()
                .statusCode(400)
        ...
        RestAssured.given()
                .spec(requestSpec)
                .when()
                .queryParam(ParameterNames.COUNTRY_CODE_PARAM_NAME,"to")
                .get(Path.AIRPORTS)
                .then()
                .assertThat()
                .statusCode(200)
    ...
    public void getAirportByIata() {
        RestAssured.given()
                .spec(requestSpec)
                .when()
                .pathParams(ParameterNames.IATA_PARAM_NAME,"xxx")
        ...
        RestAssured.given()
                .spec(requestSpec)
                .when()
                .pathParams(ParameterNames.IATA_PARAM_NAME,"itm")
                .get(Path.AIRPORT_BY_IATA)
                .then()
                .assertThat()
                .statusCode(200)
