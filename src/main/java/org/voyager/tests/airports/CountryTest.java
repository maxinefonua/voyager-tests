...
public class CountryTest {
    ...
    public void getCountriesWithContinent() {
        RestAssured.given()
                .spec(requestSpec)
                .when()
                .queryParam(ParameterNames.CONTINENT,"zz")
                .get(Path.COUNTRIES)
                .then()
                .assertThat()
                .statusCode(400)
        ...
        RestAssured.given()
                .spec(requestSpec)
                .when()
                .queryParam(ParameterNames.CONTINENT,"OC")
                .get(Path.COUNTRIES)
                .then()
                .assertThat()
                .statusCode(200)
        ...
        RestAssured.given()
                .spec(requestSpec)
                .when()
                .queryParam(ParameterNames.CONTINENT,"OC","AS")
                .get(Path.COUNTRIES)
                .then()
                .assertThat()
                .statusCode(200)
    ...
    public void getCountryByCode() {
        ...
        RestAssured.given()
                .spec(requestSpec)
                .when()
                .pathParams(ParameterNames.COUNTRY_CODE,"FI")
                .get(Path.COUNTRIES.concat(Path.BY_COUNTRY_CODE))
                .then()
                .assertThat()
                .statusCode(200)
